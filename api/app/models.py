...
class Users(SQLModel, table=True):
  id: Optional[int] = Field(None, primary_key=True, title="ユーザID", description="ユーザを一意に識別するためのID")
...
class ChatLog(SQLModel, table=True):
  id: Optional[int] = Field(None, primary_key=True, title="チャットID", description="チャットを一意に識別するためのID")
  ...
  session_id: Optional[int] = Field(None, foreign_key="sessions.id", title="セッションID", description="関連するセッションのID")
  class Config:
    schema_extra = {
      "example": {
        "id": 1,
...
class Sessions(SQLModel, table=True):
  id: Optional[int] = Field(None, primary_key=True, title="セッションID", description="セッションを一意に識別するためのID")
  ...
  user_id: Optional[int] = Field(..., foreign_key="users.id", title="ユーザID", description="関連するユーザのID")
  class Config:
    schema_extra = {
      "example": {
        "id": 1,
...
class ErrorLog(SQLModel, table=True):
  id: Optional[int] = Field(None, primary_key=True, title="エラーログID", description="エラーログを一意に識別するためのID")
  ...
  session_id: Optional[int] = Field(..., foreign_key="sessions.id", title="セッションID", description="関連するセッションのID")
  class Config:
    schema_extra = {
      "example": {
        "id": 1,
